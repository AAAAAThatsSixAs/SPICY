...
extern int32_t __ece391_create(const uint8_t* filename);
extern int32_t __ece391_remove(const uint8_t* filename);
...
DO_CALL(__ece391_create, 11/*SYS_CREATE*/);
DO_CALL(__ece391_remove, 12/*SYS_REMOVE*/);
...
int32_t ece391_create(const uint8_t* filename)
{
    if (filename != NULL)
        return __ece391_create(filename);
}

int32_t ece391_remove(const uint8_t* filename)
{
    if (filename != NULL)
        return __ece391_remove(filename);
}